  ...
  const problems = [
    {
      ...
      text: "Traditional agencies charge fat retainers for 'brand awareness' and 'engagement.' You get nice-looking reports but zero sales. Sound familiar?"
    },
    {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
          {problems.map((problem, index) => (
            <Card key={index} className="bg-muted border-none shadow-sm transform transition-transform hover:-translate-y-2 duration-300">
              ...
              <CardContent>
                <p className="text-foreground/80 ml-[68px] -mt-4">{problem.text}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        <div className="mt-16 text-center">
            <p className="text-xl font-bold text-foreground max-w-3xl mx-auto border-l-4 border-primary pl-4 italic">
